...
%% generate_wam_python_optimized_benchmark.pl
%%
%% Generates a Python WAM benchmark from OPTIMIZED Prolog.
%%
%% Pipeline:
...
%%   4. Compile ALL predicates (base + generated) to WAM -> Python
%%
%% This bridges the Prolog optimization passes with the WAM Python target,
%% ensuring the WAM compiler sees the same optimized predicates that make
%% the SWI-Prolog benchmarks fast.
%%
%% Usage:
%%   swipl -q -s generate_wam_python_optimized_benchmark.pl -- \
