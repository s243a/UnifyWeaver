...
main :-
    Predicates = [
        ...
        probe_bench:dbg_sum/3, probe_bench:dbg_sum_args/5,
        probe_bench:probe_dbg_sum_fg/0, probe_bench:probe_dbg_sum_g/0,
        probe_bench:probe_dbg_sum_f12/0, probe_bench:probe_dbg_sum_f1g/0,
        probe_bench:probe_nested_build/0,
