...
@.fn_state = private constant [6 x i8] c"state\00"
@.fn__2B = private constant [2 x i8] c"+\00"
@.fn_record = private constant [7 x i8] c"record\00"
@.fn_plawk_5Foptions = private constant [14 x i8] c"plawk_options\00"
@.fn_outputs = private constant [8 x i8] c"outputs\00"
@.fn_normalize_5Foutputs = private constant [18 x i8] c"normalize_outputs\00"
@.fn_item_5Ffield = private constant [11 x i8] c"item_field\00"
@.fn_print_5Ffields = private constant [13 x i8] c"print_fields\00"
@.fn_print_5Fitem = private constant [11 x i8] c"print_item\00"
@.fn_state_5Foutputs = private constant [14 x i8] c"state_outputs\00"
@.fn_append_5Foutput = private constant [14 x i8] c"append_output\00"
@.fn_ofs = private constant [4 x i8] c"ofs\00"
@.fn_fs = private constant [3 x i8] c"fs\00"
@.fn_nf = private constant [3 x i8] c"nf\00"
@.fn_nr = private constant [3 x i8] c"nr\00"
@.fn_item_5Ffield_5Fcount = private constant [17 x i8] c"item_field_count\00"
@.fn_increment_5Fcounter = private constant [18 x i8] c"increment_counter\00"
@.fn_state_5Fcounter = private constant [14 x i8] c"state_counter\00"
...
@.atom_str_98 = private constant [18 x i8] c"normalize_outputs\00"
@.atom_str_99 = private constant [11 x i8] c"item_field\00"
@.atom_str_100 = private constant [13 x i8] c"print_fields\00"
@.atom_str_101 = private constant [11 x i8] c"print_item\00"
...
@wam_atom_strings = private constant [111 x i8*] [
  ...
  i8* getelementptr ([18 x i8], [18 x i8]* @.atom_str_98, i32 0, i32 0),
  i8* getelementptr ([11 x i8], [11 x i8]* @.atom_str_99, i32 0, i32 0),
  i8* getelementptr ([13 x i8], [13 x i8]* @.atom_str_100, i32 0, i32 0),
  i8* getelementptr ([11 x i8], [11 x i8]* @.atom_str_101, i32 0, i32 0),
...
@module_code = private constant [245 x %Instruction] [
  %Instruction { i32 3, i64 ptrtoint ([6 x i8]* @.fn_state to i64), i64 262144 },
  ...
  %Instruction { i32 5, i64 18, i64 0 },
  %Instruction { i32 5, i64 19, i64 0 },
  %Instruction { i32 3, i64 ptrtoint ([6 x i8]* @.fn_state to i64), i64 262145 },
  ...
  %Instruction { i32 3, i64 ptrtoint ([7 x i8]* @.fn_record to i64), i64 196608 },
  ...
  %Instruction { i32 3, i64 ptrtoint ([7 x i8]* @.fn_record to i64), i64 131072 },
  %Instruction { i32 7, i64 97, i64 0 },
  %Instruction { i32 5, i64 16, i64 0 },
  ...
  %Instruction { i32 3, i64 ptrtoint ([6 x i8]* @.fn_state to i64), i64 262146 },
  ...
  %Instruction { i32 18, i64 22, i64 2 },
  %Instruction { i32 10, i64 48, i64 0 },
  ...
  %Instruction { i32 17, i64 0, i64 0 },
  %Instruction { i32 19, i64 22, i64 0 },
  %Instruction { i32 16, i64 0, i64 0 },
  ...
  %Instruction { i32 18, i64 17, i64 3 },
  %Instruction { i32 10, i64 48, i64 0 },
  ...
  %Instruction { i32 3, i64 ptrtoint ([7 x i8]* @.fn_record to i64), i64 196609 },
  %Instruction { i32 7, i64 97, i64 0 },
  %Instruction { i32 5, i64 16, i64 0 },
  %Instruction { i32 5, i64 17, i64 0 },
  ...
  %Instruction { i32 17, i64 0, i64 0 },
  %Instruction { i32 20, i64 0, i64 0 },
  %Instruction { i32 23, i64 20, i64 0 },
  %Instruction { i32 16, i64 0, i64 0 },
  %Instruction { i32 1, i64 48, i64 0 },
  %Instruction { i32 3, i64 ptrtoint ([7 x i8]* @.fn_record to i64), i64 196609 },
  %Instruction { i32 7, i64 97, i64 0 },
  ...
  %Instruction { i32 16, i64 0, i64 0 },
  %Instruction { i32 1, i64 48, i64 0 },
  %Instruction { i32 3, i64 ptrtoint ([7 x i8]* @.fn_record to i64), i64 131073 },
  %Instruction { i32 7, i64 97, i64 0 },
  %Instruction { i32 5, i64 49, i64 0 },
  %Instruction { i32 1, i64 50, i64 2 },
  %Instruction { i32 10, i64 48, i64 0 },
  ...
  %Instruction { i32 16, i64 0, i64 0 },
  %Instruction { i32 3, i64 ptrtoint ([8 x i8]* @.fn_outputs to i64), i64 65536 },
  %Instruction { i32 5, i64 16, i64 0 },
...
@wam_meta_call_functors = private constant [13 x i8*] [
  i8* bitcast ([18 x i8]* @.fn_normalize_5Foutputs to i8*),
  i8* bitcast ([11 x i8]* @.fn_item_5Ffield to i8*),
  i8* bitcast ([13 x i8]* @.fn_print_5Ffields to i8*),
  i8* bitcast ([11 x i8]* @.fn_print_5Fitem to i8*),
  i8* bitcast ([14 x i8]* @.fn_state_5Foutputs to i8*),
  i8* bitcast ([14 x i8]* @.fn_append_5Foutput to i8*),
  i8* bitcast ([4 x i8]* @.fn_ofs to i8*),
  i8* bitcast ([3 x i8]* @.fn_fs to i8*),
  i8* bitcast ([3 x i8]* @.fn_nf to i8*),
  i8* bitcast ([3 x i8]* @.fn_nr to i8*),
  i8* bitcast ([17 x i8]* @.fn_item_5Ffield_5Fcount to i8*),
  i8* bitcast ([18 x i8]* @.fn_increment_5Fcounter to i8*),
  i8* bitcast ([14 x i8]* @.fn_state_5Fcounter to i8*)
]
...
compound_loop:
  ...
  %cdone = icmp sge i32 %ci, 13
  br i1 %cdone, label %fail, label %compound_check

compound_check:
  %functor_ptr = getelementptr [13 x i8*], [13 x i8*]* @wam_meta_call_functors, i32 0, i32 %ci
  %cand_functor = load i8*, i8** %functor_ptr
  %functor_match = icmp eq i8* %compound_functor, %cand_functor
  %carity_ptr = getelementptr [13 x i32], [13 x i32]* @wam_meta_call_arities, i32 0, i32 %ci
...
dispatch_compound:
  %clabel_ptr = getelementptr [13 x i32], [13 x i32]* @wam_meta_call_label_indexes, i32 0, i32 %ci
...
; WAM-compiled predicate: print_item/3 (merged module code, start PC 145)
@print_item_start_pc = private constant i32 145
...
; WAM-compiled predicate: print_fields/3 (merged module code, start PC 158)
@print_fields_start_pc = private constant i32 158
...
entry:
  %vm = call %WamState* @wam_state_new(
    ...
    i32* getelementptr ([27 x i32], [27 x i32]* @module_labels, i32 0, i32 0),
    i32 27)
  call void @wam_set_pc(%WamState* %vm, i32 158)
  call void @wam_set_reg(%WamState* %vm, i32 0, %Value %a1)
  call void @wam_set_reg(%WamState* %vm, i32 1, %Value %a2)
  call void @wam_set_reg(%WamState* %vm, i32 2, %Value %a3)
  %result = call i1 @run_loop(%WamState* %vm)
...
; WAM-compiled predicate: item_field/3 (merged module code, start PC 177)
@item_field_start_pc = private constant i32 177
...
; WAM-compiled predicate: normalize_outputs/2 (merged module code, start PC 226)
@normalize_outputs_start_pc = private constant i32 226
...
entry:
  %vm = call %WamState* @wam_state_new(
    ...
    i32* getelementptr ([27 x i32], [27 x i32]* @module_labels, i32 0, i32 0),
    i32 27)
  call void @wam_set_pc(%WamState* %vm, i32 226)
  call void @wam_set_reg(%WamState* %vm, i32 0, %Value %a1)
  call void @wam_set_reg(%WamState* %vm, i32 1, %Value %a2)
  %result = call i1 @run_loop(%WamState* %vm)
  ; Free the state before returning so repeated bench-loop invocations
