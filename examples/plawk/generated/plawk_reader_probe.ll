; ModuleID = 'plawk_reader_probe'
; Generated by UnifyWeaver WAM-to-LLVM Hybrid Target
; Date: reproducible
source_filename = "plawk_reader_probe.ll"
...
@.fn_stream_5Freader_5Fprobe = private constant [20 x i8] c"stream_reader_probe\00"
...
@.atom_str_97 = private constant [20 x i8] c"stream_reader_probe\00"

@wam_atom_strings = private constant [98 x i8*] [
  i8* null,
  ...
  i8* getelementptr ([20 x i8], [20 x i8]* @.atom_str_97, i32 0, i32 0)
]
@wam_atom_string_count = private constant i32 98
...
lookup_static:
  %slot_ptr = getelementptr [98 x i8*], [98 x i8*]* @wam_atom_strings, i32 0, i64 %id
...
scan_static_check:
  %st_slot_ptr = getelementptr [98 x i8*], [98 x i8*]* @wam_atom_strings, i32 0, i64 %s_i
...
@module_code = private constant [21 x %Instruction] [
  %Instruction { i32 16, i64 0, i64 0 },
  %Instruction { i32 1, i64 20, i64 0 },
  %Instruction { i32 1, i64 48, i64 1 },
  %Instruction { i32 1, i64 49, i64 2 },
  %Instruction { i32 1, i64 50, i64 3 },
  %Instruction { i32 10, i64 20, i64 0 },
  %Instruction { i32 9, i64 51, i64 1 },
  %Instruction { i32 21, i64 166, i64 2 },
  %Instruction { i32 10, i64 51, i64 0 },
  %Instruction { i32 10, i64 48, i64 1 },
  %Instruction { i32 21, i64 167, i64 2 },
  %Instruction { i32 10, i64 51, i64 0 },
  ...
  %Instruction { i32 21, i64 167, i64 2 },
  %Instruction { i32 10, i64 51, i64 0 },
  %Instruction { i32 21, i64 168, i64 1 },
  %Instruction { i32 17, i64 0, i64 0 },
  %Instruction { i32 20, i64 0, i64 0 }
]

@module_labels = private constant [1 x i32] [
  i32 0
]
...
@wam_meta_call_functors = private constant [1 x i8*] [
  i8* bitcast ([20 x i8]* @.fn_stream_5Freader_5Fprobe to i8*)
]
...
; WAM-compiled predicate: stream_reader_probe/4 (merged module code, start PC 0)
@stream_reader_probe_start_pc = private constant i32 0

define i1 @stream_reader_probe(%Value %a1, %Value %a2, %Value %a3, %Value %a4) {
entry:
