; ModuleID = 'plawk_loop_probe'
; Generated by UnifyWeaver WAM-to-LLVM Hybrid Target
; Date: reproducible
source_filename = "plawk_loop_probe.ll"
...
@.fn_process_5Fall = private constant [12 x i8] c"process_all\00"
...
@.atom_str_97 = private constant [12 x i8] c"end_of_file\00"
@.atom_str_98 = private constant [4 x i8] c"yes\00"
@.atom_str_99 = private constant [12 x i8] c"process_all\00"

@wam_atom_strings = private constant [100 x i8*] [
  i8* null,
  ...
  i8* getelementptr ([4 x i8], [4 x i8]* @.atom_str_98, i32 0, i32 0),
  i8* getelementptr ([12 x i8], [12 x i8]* @.atom_str_99, i32 0, i32 0)
]
@wam_atom_string_count = private constant i32 100
...
lookup_static:
  %slot_ptr = getelementptr [100 x i8*], [100 x i8*]* @wam_atom_strings, i32 0, i64 %id
...
scan_static_check:
  %st_slot_ptr = getelementptr [100 x i8*], [100 x i8*]* @wam_atom_strings, i32 0, i64 %s_i
...
@module_code = private constant [45 x %Instruction] [
  %Instruction { i32 16, i64 0, i64 0 },
  %Instruction { i32 1, i64 51, i64 0 },
  %Instruction { i32 1, i64 52, i64 1 },
  %Instruction { i32 1, i64 23, i64 2 },
  %Instruction { i32 1, i64 54, i64 3 },
  %Instruction { i32 10, i64 51, i64 0 },
  %Instruction { i32 9, i64 48, i64 1 },
  %Instruction { i32 10, i64 23, i64 2 },
  %Instruction { i32 9, i64 49, i64 3 },
  %Instruction { i32 18, i64 -1, i64 4 },
  %Instruction { i32 33, i64 55, i64 0 },
  %Instruction { i32 22, i64 1, i64 0 },
  %Instruction { i32 10, i64 48, i64 0 },
  %Instruction { i32 8, i64 97, i64 1 },
  %Instruction { i32 21, i64 7, i64 2 },
  %Instruction { i32 34, i64 55, i64 0 },
  %Instruction { i32 10, i64 54, i64 0 },
  %Instruction { i32 10, i64 49, i64 1 },
  %Instruction { i32 21, i64 24, i64 2 },
  %Instruction { i32 32, i64 4, i64 0 },
  %Instruction { i32 24, i64 0, i64 0 },
  %Instruction { i32 10, i64 52, i64 0 },
  %Instruction { i32 10, i64 48, i64 1 },
  %Instruction { i32 10, i64 49, i64 2 },
  %Instruction { i32 9, i64 53, i64 3 },
  %Instruction { i32 9, i64 50, i64 4 },
  %Instruction { i32 18, i64 -1, i64 5 },
  %Instruction { i32 33, i64 56, i64 0 },
  %Instruction { i32 22, i64 2, i64 0 },
  %Instruction { i32 10, i64 50, i64 0 },
  %Instruction { i32 8, i64 98, i64 1 },
  %Instruction { i32 21, i64 7, i64 2 },
  %Instruction { i32 34, i64 56, i64 0 },
  %Instruction { i32 10, i64 51, i64 0 },
  %Instruction { i32 10, i64 52, i64 1 },
  %Instruction { i32 10, i64 53, i64 2 },
  %Instruction { i32 10, i64 54, i64 3 },
  %Instruction { i32 18, i64 0, i64 4 },
  %Instruction { i32 32, i64 3, i64 0 },
  %Instruction { i32 24, i64 0, i64 0 },
  %Instruction { i32 10, i64 54, i64 0 },
  %Instruction { i32 10, i64 53, i64 1 },
  %Instruction { i32 21, i64 24, i64 2 },
  %Instruction { i32 17, i64 0, i64 0 },
  %Instruction { i32 20, i64 0, i64 0 }
]

@module_labels = private constant [5 x i32] [
  i32 0,
  i32 20,
  i32 39,
  i32 43,
...
@wam_meta_call_atom_ids = private constant [1 x i64] [
  i64 99
]
@wam_meta_call_functors = private constant [1 x i8*] [
  i8* bitcast ([12 x i8]* @.fn_process_5Fall to i8*)
]
@wam_meta_call_arities = private constant [1 x i32] [
  i32 4
]
@wam_meta_call_label_indexes = private constant [1 x i32] [
  i32 0
]
...
loop:
  ...
  %done = icmp sge i32 %i, 1
  br i1 %done, label %fail, label %check

check:
  %atom_ptr = getelementptr [1 x i64], [1 x i64]* @wam_meta_call_atom_ids, i32 0, i32 %i
  %cand_atom = load i64, i64* %atom_ptr
  %atom_match = icmp eq i64 %atom_id, %cand_atom
  %arity_ptr = getelementptr [1 x i32], [1 x i32]* @wam_meta_call_arities, i32 0, i32 %i
...
dispatch:
  %label_ptr = getelementptr [1 x i32], [1 x i32]* @wam_meta_call_label_indexes, i32 0, i32 %i
...
compound_loop:
  ...
  %cdone = icmp sge i32 %ci, 1
  br i1 %cdone, label %fail, label %compound_check

compound_check:
  %functor_ptr = getelementptr [1 x i8*], [1 x i8*]* @wam_meta_call_functors, i32 0, i32 %ci
  %cand_functor = load i8*, i8** %functor_ptr
  %functor_match = icmp eq i8* %compound_functor, %cand_functor
  %carity_ptr = getelementptr [1 x i32], [1 x i32]* @wam_meta_call_arities, i32 0, i32 %ci
...
dispatch_compound:
  %clabel_ptr = getelementptr [1 x i32], [1 x i32]* @wam_meta_call_label_indexes, i32 0, i32 %ci
...
; WAM-compiled predicate: process_all/4 (merged module code, start PC 0)
@process_all_start_pc = private constant i32 0

define i1 @process_all(%Value %a1, %Value %a2, %Value %a3, %Value %a4) {
entry:
  %vm = call %WamState* @wam_state_new(
    %Instruction* getelementptr ([45 x %Instruction], [45 x %Instruction]* @module_code, i32 0, i32 0),
    i32 45,
    i32* getelementptr ([5 x i32], [5 x i32]* @module_labels, i32 0, i32 0),
    i32 5)
