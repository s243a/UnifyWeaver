...
(func $step (param $code_base i32) (param $pc i32) (result i32)
  ...
  (block $default
    ...
    (block $b1
    (block $b0
    (br_table $b0 $b1 $b2 $b3 $b4 $b5 $b6 $b7 $b8 $b9 $b10 $b11 $b12 $b13 $b14 $b15 $b16 $b17 $b18 $b19 $b20 $b21 $b22 $b23 $b24 $b25 $b26 $b27 $default (local.get $tag))
  ) ;; $b0 (get_constant)
