...
(func $wam_init (param $heap_base i32)
  ...
  ;; Reset aggregate and arg/3 iteration state — otherwise stale globals
  ;; from a prior query corrupt detection logic across predicate
  ;; invocations sharing the same WASM instance.
  ...
  (global.set $arg_iter_n (i32.const 0))
  (global.set $arg_iter_arity (i32.const 0))
  (global.set $arg_iter_t_addr (i32.const 0))
