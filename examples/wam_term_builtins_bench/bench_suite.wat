...
(func $builtin_copy_term (result i32)
  ...
  (call $set_pc (i32.const 0))
  (call $run_loop (i32.const 131072) (i32.const 296)))
...
(func $term_depth_args_5 (export "term_depth_args_5") (result i32)
  (call $wam_init (i32.const 196608))
  (call $set_pc (i32.const 219))
  (call $run_loop (i32.const 131072) (i32.const 296)))
(func $fib_3 (export "fib_3") (result i32)
  (call $wam_init (i32.const 196608))
  (call $set_pc (i32.const 257))
  (call $run_loop (i32.const 131072) (i32.const 296)))
