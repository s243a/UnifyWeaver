...
(func $step (param $code_base i32) (param $pc i32) (result i32)
  ...
  (block $default
    ...
    (block $b1
    (block $b0
    (br_table $b0 $b1 $b2 $b3 $b4 $b5 $b6 $b7 $b8 $b9 $b10 $b11 $b12 $b13 $b14 $b15 $b16 $b17 $b18 $b19 $b20 $b21 $b22 $b23 $b24 $b25 $b26 $b27 $b28 $b29 $b30 $b31 $b32 $b33 $b34 $b35 $b36 $b37 $b38 $b39 $b40 $b41 $b42 $b43 $b44 $b45 $b46 $b47 $b48 $b49 $b50 $b51 $b52 $b53 $b54 $b55 $b56 $b57 $default (local.get $tag))
  ) ;; $b0 (get_constant)
...
(func $builtin_copy_term (result i32)
  ...
  (call $set_pc (i32.const 0))
  (call $run_loop (i32.const 131072) (i32.const 344)))
