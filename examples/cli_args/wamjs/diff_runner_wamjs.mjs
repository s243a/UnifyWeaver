...
//
// diff_runner_wamjs.mjs -- the JS-WAM side of the differential harness.
//
...
// the JS-WAM compiled parser's edge shim instead of from the vendored oracle.
//
//   node examples/cli_args/wamjs/diff_runner_wamjs.mjs < lines.txt > wamjs.jsonl
