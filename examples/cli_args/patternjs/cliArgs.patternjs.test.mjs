...
//
// cliArgs.patternjs.test.mjs -- peerhailer's own 17-test contract corpus
// (examples/cli_args/oracle/cliArgs.test.mjs), run against the TRANSPILED
// parser. The ONLY edit is the import specifier on the line marked below;
// every assertion is the oracle's, verbatim.
//
