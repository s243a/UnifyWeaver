...
@module_code = private constant [194 x %Instruction] [
  ...
  %Instruction { i32 9, i64 17, i64 2 },
  %Instruction { i32 17, i64 0, i64 0 },
  %Instruction { i32 19, i64 11, i64 0 },
  %Instruction { i32 16, i64 0, i64 0 },
  %Instruction { i32 11, i64 ptrtoint ([2 x i8]* @.fn_f to i64), i64 196608 },
  %Instruction { i32 15, i64 1, i64 1 },
  %Instruction { i32 13, i64 17, i64 0 },
  ...
  %Instruction { i32 17, i64 0, i64 0 },
  %Instruction { i32 19, i64 11, i64 0 },
  %Instruction { i32 22, i64 12, i64 0 },
  %Instruction { i32 16, i64 0, i64 0 },
  ...
  %Instruction { i32 10, i64 17, i64 1 },
  %Instruction { i32 9, i64 22, i64 2 },
  %Instruction { i32 18, i64 11, i64 3 },
...
@module_labels = private constant [15 x i32] [
  i32 0,
  i32 1,
  i32 10,
  i32 25,
...
entry:
  %vm = call %WamState* @wam_state_new(
    %Instruction* getelementptr ([194 x %Instruction], [194 x %Instruction]* @module_code, i32 0, i32 0),
    i32 194,
    i32* getelementptr ([15 x i32], [15 x i32]* @module_labels, i32 0, i32 0),
    i32 15)
...
; WAM-compiled predicate: sum_ints/3 (merged module code, start PC 120)
@sum_ints_start_pc = private constant i32 120
...
; WAM-compiled predicate: sum_ints_args/5 (merged module code, start PC 151)
@sum_ints_args_start_pc = private constant i32 151
