...
; WAM-compiled predicate: bench_true/0
@bench_true_code = private constant [1 x %Instruction] [
  %Instruction { i32 20, i64 0, i64 0 }
]

@bench_true_labels = private constant [1 x i32] [
  i32 0
]
...
entry:
  %vm = call %WamState* @wam_state_new(
    %Instruction* getelementptr ([1 x %Instruction], [1 x %Instruction]* @bench_true_code, i32 0, i32 0),
    i32 1,
    i32* getelementptr ([1 x i32], [1 x i32]* @bench_true_labels, i32 0, i32 0),
    i32 1)
...
; WAM-compiled predicate: bench_is_arith/0
@bench_is_arith_code = private constant [9 x %Instruction] [
...
@bench_is_arith_labels = private constant [1 x i32] [
  i32 0
]
...
entry:
  %vm = call %WamState* @wam_state_new(
    %Instruction* getelementptr ([9 x %Instruction], [9 x %Instruction]* @bench_is_arith_code, i32 0, i32 0),
    i32 9,
    i32* getelementptr ([1 x i32], [1 x i32]* @bench_is_arith_labels, i32 0, i32 0),
    i32 1)
...
; WAM-compiled predicate: bench_unify/0
@bench_unify_code = private constant [15 x %Instruction] [
...
@bench_unify_labels = private constant [1 x i32] [
  i32 0
]
...
entry:
  %vm = call %WamState* @wam_state_new(
    %Instruction* getelementptr ([15 x %Instruction], [15 x %Instruction]* @bench_unify_code, i32 0, i32 0),
    i32 15,
    i32* getelementptr ([1 x i32], [1 x i32]* @bench_unify_labels, i32 0, i32 0),
    i32 1)
...
; WAM-compiled predicate: bench_functor_read/0
@bench_functor_read_code = private constant [10 x %Instruction] [
  %Instruction { i32 16, i64 0, i64 0 },
...
@bench_functor_read_labels = private constant [1 x i32] [
  i32 0
]
...
entry:
  %vm = call %WamState* @wam_state_new(
    %Instruction* getelementptr ([10 x %Instruction], [10 x %Instruction]* @bench_functor_read_code, i32 0, i32 0),
    i32 10,
    i32* getelementptr ([1 x i32], [1 x i32]* @bench_functor_read_labels, i32 0, i32 0),
    i32 1)
...
; WAM-compiled predicate: bench_arg_read/0
@bench_arg_read_code = private constant [10 x %Instruction] [
  %Instruction { i32 16, i64 0, i64 0 },
...
@bench_arg_read_labels = private constant [1 x i32] [
  i32 0
]
...
entry:
  %vm = call %WamState* @wam_state_new(
    %Instruction* getelementptr ([10 x %Instruction], [10 x %Instruction]* @bench_arg_read_code, i32 0, i32 0),
    i32 10,
    i32* getelementptr ([1 x i32], [1 x i32]* @bench_arg_read_labels, i32 0, i32 0),
    i32 1)
...
; WAM-compiled predicate: bench_univ_decomp/0
@bench_univ_decomp_code = private constant [8 x %Instruction] [
  %Instruction { i32 16, i64 0, i64 0 },
...
@bench_univ_decomp_labels = private constant [1 x i32] [
  i32 0
]
...
entry:
  %vm = call %WamState* @wam_state_new(
    %Instruction* getelementptr ([8 x %Instruction], [8 x %Instruction]* @bench_univ_decomp_code, i32 0, i32 0),
    i32 8,
    i32* getelementptr ([1 x i32], [1 x i32]* @bench_univ_decomp_labels, i32 0, i32 0),
    i32 1)
...
; WAM-compiled predicate: bench_copy_flat/0
@bench_copy_flat_code = private constant [8 x %Instruction] [
  %Instruction { i32 16, i64 0, i64 0 },
  %Instruction { i32 11, i64 ptrtoint ([4 x i8]* @.fn_foo to i64), i64 131072 },
  %Instruction { i32 15, i64 1, i64 0 },
  %Instruction { i32 15, i64 2, i64 0 },
...
@bench_copy_flat_labels = private constant [1 x i32] [
  i32 0
]
...
entry:
  %vm = call %WamState* @wam_state_new(
    %Instruction* getelementptr ([8 x %Instruction], [8 x %Instruction]* @bench_copy_flat_code, i32 0, i32 0),
    i32 8,
    i32* getelementptr ([1 x i32], [1 x i32]* @bench_copy_flat_labels, i32 0, i32 0),
    i32 1)
...
; WAM-compiled predicate: bench_copy_nested/0
@bench_copy_nested_code = private constant [12 x %Instruction] [
  %Instruction { i32 16, i64 0, i64 0 },
...
@bench_copy_nested_labels = private constant [1 x i32] [
  i32 0
]
...
entry:
  %vm = call %WamState* @wam_state_new(
    %Instruction* getelementptr ([12 x %Instruction], [12 x %Instruction]* @bench_copy_nested_code, i32 0, i32 0),
    i32 12,
    i32* getelementptr ([1 x i32], [1 x i32]* @bench_copy_nested_labels, i32 0, i32 0),
    i32 1)
