...
gc.bind:
  ; Unbound: bind to constant with proper tag. wam_bind_reg writes
  ; through any Ref so put_variable-aliased registers see the binding.
...
get_variable:
  ...
  ret i1 true
get_value:
  ; op1 = Xn index, op2 = Ai index — unify Xn with Ai.
  ; Both sides derefed through Ref chains before the unbound check.
