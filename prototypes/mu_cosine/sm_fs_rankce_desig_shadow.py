#!/usr/bin/env python3
"""SHADOW: DE-SIGMOIDED FULL-CAPACITY listwise rank-CE (all 4.0M params trainable, LR 2e-4) — the owner's framing:
        ...
        for f in range(5):
            ...
            for step in range(STEPS):
                ...
                loss = torch.nn.functional.cross_entropy(
                    (torch.logit(mu.clamp(1e-6, 1 - 1e-6))).unsqueeze(0), torch.zeros(1, dtype=torch.long, device=dev))
