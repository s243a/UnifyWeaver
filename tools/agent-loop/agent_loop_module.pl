...
generate_parity_report :-
    ...
    write(S, '| Method | Module | Python | Rust | Elixir | Prolog |\n'),
    write(S, '|--------|--------|--------|------|--------|--------|\n'),
    forall(shared_logic(Cat, Method, _Props), (
        ...
        format(S, '| `~w` | ~w | ~w | ~w | ~w | ~w |~n', [Method, Cat, Py, Rs, Ex, Pl])
    )),
    %% --- summary counts ---
    ...
    format(S, '\n**Total: ~w methods** — Python: ~w, Rust: ~w, Elixir: ~w, Prolog: ~w\n\n', [Total, PyN, RsN, ExN, PlN]),
