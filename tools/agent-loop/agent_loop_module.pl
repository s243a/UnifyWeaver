...
%% Generate __init__.py for backends
generate_backends_init :-
    open('generated/backends/__init__.py', write, Stream),
...
%% Generate a backend Python file
...
%% Generate tools_generated.py
generate_tools :-
    open('generated/tools_generated.py', write, Stream),
...
%% Generate README
generate_readme :-
    open('generated/README.md', write, Stream),
