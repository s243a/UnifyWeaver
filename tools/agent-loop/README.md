...
| `shared_logic/3` facts | 200 (5-target parity: Python, Rust, Elixir, Prolog, Clojure) |
...
| Total tests | 2511+ Prolog (incl. 1408 declarative) + 163 Rust + 163 Python + 153 Clojure |
...
**200 shared methods** across 10 modules (compiled for Python, Rust, Elixir, Prolog, and Clojure):
...
**All 200 shared_logic methods are actively wired (5 targets: Python, Rust, Elixir, Prolog, Clojure)** — emitted from `compile_logic` during generation for Python, Rust, Elixir, and Prolog targets:
