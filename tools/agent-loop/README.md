...
| Clojure | `generated/clojure/` (9 modules + project.clj) | Full shared_logic methods with prefix S-expression notation + kebab-case identifiers + keyword state access + defn with docstrings + ns declarations + Cheshire JSON deps |
...
| `shared_logic/3` facts | 52 (5-target parity: Python, Rust, Elixir, Prolog, Clojure) |
...
| Total tests | 1081 + 520 declarative + 139 Rust + 148 Python (1081 Prolog unit + 520 auto-generated + 53 Elixir ExUnit + 44 Prolog integration + 148 Python + 139 cargo test) |
...
**All 52 shared_logic methods are actively wired (5 targets: Python, Rust, Elixir, Prolog, Clojure)** — emitted from `compile_logic` during generation for Python, Rust, Elixir, and Prolog targets:
