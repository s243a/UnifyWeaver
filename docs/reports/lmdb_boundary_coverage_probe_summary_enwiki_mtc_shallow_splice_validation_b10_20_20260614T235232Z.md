...
Graph: `enwiki_mtc_shallow_splice_validation_b10_20`
...
- Target-ancestor boundary collection scope was `root-cone`.
...
- `exact` budget `10`: `11` terminal prefixes, `1` direct root paths, `10` boundary-hit prefixes, boundary-hit fraction `0.909091`, `0` budget-exhausted prefixes, and spliced root mass `63.000`.
- `exact` budget `20`: `11` terminal prefixes, `1` direct root paths, `10` boundary-hit prefixes, boundary-hit fraction `0.909091`, `0` budget-exhausted prefixes, and spliced root mass `63.000`.
...
- The active parent filter rejected `44` parent edges. Under `root-cone`, these skips are part of the scoped experiment definition, not necessarily data errors.
...
|------|-------------------:|--------:|------------------:|---------------------------:|--------------------:|-------------------------------:|-------------------------------:|-----------------------------------:|---------------------------:|-------------------------------:|-------------------------:|------------------------:|-------------------------:|---------------------------:|--------------------------:|------------:|------------------------------:|------------------------------------:|-----------------------------------:|
| exact | 10 | 4 | 4 | 11 | 1 | 10 | 0.909091 | 0 | 0 | 6.200 | 63.000 | 63.000000 | 5.746 | 0 | 0 | 0 | 22 | 0 | 0 |
| exact | 20 | 4 | 4 | 11 | 1 | 10 | 0.909091 | 0 | 0 | 6.200 | 63.000 | 63.000000 | 5.746 | 0 | 0 | 0 | 22 | 0 | 0 |
...
| 20 | 4 | 4 | 4 | 0.000 | 0.000000 | 0.000000 | 0 | 0 | 39.500 |
...
| 707612 | 20 | yes | 43.000 | 43 | 0.000 | 43.000000 | 43.000000 | 0.000000 | 6.395 | 6.395 | 0.000000 | no | no |
| 32026258 | 10 | yes | 10.000 | 10 | 0.000 | 10.000000 | 10.000000 | 0.000000 | 4.200 | 4.200 | 0.000000 | no | no |
| 32026258 | 20 | yes | 10.000 | 10 | 0.000 | 10.000000 | 10.000000 | 0.000000 | 4.200 | 4.200 | 0.000000 | no | no |
| 37358201 | 10 | yes | 2.000 | 2 | 0.000 | 2.000000 | 2.000000 | 0.000000 | 3.500 | 3.500 | 0.000000 | no | no |
| 37358201 | 20 | yes | 2.000 | 2 | 0.000 | 2.000000 | 2.000000 | 0.000000 | 3.500 | 3.500 | 0.000000 | no | no |
| 75467625 | 10 | yes | 8.000 | 8 | 0.000 | 8.000000 | 8.000000 | 0.000000 | 4.750 | 4.750 | 0.000000 | no | no |
| 75467625 | 20 | yes | 8.000 | 8 | 0.000 | 8.000000 | 8.000000 | 0.000000 | 4.750 | 4.750 | 0.000000 | no | no |
...
|------|------------:|-------------------:|------------------:|-----------:|----------------------:|----------------------:|--------------------------:|---------------------------:|-------------------------------:|----------:|------------:|------------------------------:|-------------------------:|------------------------:|-------------------------:|
| exact | 707612 | 10 | 2 | 0 | 2 | 1.000000 | 0 | 0 | 9.000 | yes | 0 | 3 | 43.000 | 43.000000 | 6.395 |
| exact | 707612 | 20 | 2 | 0 | 2 | 1.000000 | 0 | 0 | 19.000 | yes | 0 | 3 | 43.000 | 43.000000 | 6.395 |
| exact | 32026258 | 10 | 5 | 1 | 4 | 0.800000 | 0 | 0 | 6.750 | yes | 0 | 12 | 10.000 | 10.000000 | 4.200 |
| exact | 32026258 | 20 | 5 | 1 | 4 | 0.800000 | 0 | 0 | 16.750 | yes | 0 | 12 | 10.000 | 10.000000 | 4.200 |
| exact | 37358201 | 10 | 1 | 0 | 1 | 1.000000 | 0 | 0 | 8.000 | yes | 0 | 4 | 2.000 | 2.000000 | 3.500 |
| exact | 37358201 | 20 | 1 | 0 | 1 | 1.000000 | 0 | 0 | 18.000 | yes | 0 | 4 | 2.000 | 2.000000 | 3.500 |
| exact | 75467625 | 10 | 3 | 0 | 3 | 1.000000 | 0 | 0 | 8.000 | yes | 0 | 3 | 8.000 | 8.000000 | 4.750 |
| exact | 75467625 | 20 | 3 | 0 | 3 | 1.000000 | 0 | 0 | 18.000 | yes | 0 | 3 | 8.000 | 8.000000 | 4.750 |
