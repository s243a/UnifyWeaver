...
test(project_layout) :-
    once((
        ...
        directory_file_path(TmpDir,
            ...
            ProgramPath),
        directory_file_path(TmpDir,
            'src/main/scala/generated/wam_scala_layout/runtime/WamRuntime.scala',
            RuntimePath),
...
test(runtime_source_components) :-
    once((
        ...
        write_wam_scala_project(
            ...
            TmpDir),
        directory_file_path(TmpDir,
            'src/main/scala/generated/wam_scala_runtime/runtime/WamRuntime.scala',
            RuntimePath),
...
test(lmdb_adaptor_emitted_in_runtime) :-
    once((
        ...
        write_wam_scala_project(
            ...
            TmpDir),
        directory_file_path(TmpDir,
            'src/main/scala/generated/wam_scala_lmdb/runtime/WamRuntime.scala',
            RuntimePath),
        read_file_to_string(RuntimePath, Code, []),
