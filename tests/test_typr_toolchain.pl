...
test(atom_string_alias_after_native_outputs_check_with_typr, [condition(typr_cli_available)]) :-
    clear_type_declarations,
    ...
    retractall(user:atom_string_alias(_, _)).

test(sub_atom_alias_after_native_outputs_check_with_typr, [condition(typr_cli_available)]) :-
    clear_type_declarations,
...
test(per_path_count_aggregate_checks_with_typr, [condition(typr_cli_available)]) :-
    clear_type_declarations,
    retractall(user:category_parent(_, _)),
